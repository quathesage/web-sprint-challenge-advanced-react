...
1. What are the main differences between a stateful and a functional component? Stateful components implement logic and state, while functional comppnents access data and displays it in some form.

2. When does a componentWillMount function be called? What about a componentWillUpdate?
   A componentWillUpdate function is called everytime an update happens, The componetWillMount function is called whenever the component mounts.

3. Define stateful logic.
   Stateful logic creates, modifies, and ends state.

4. What are the three step of creating a successful test? What is done in each phase?
   Arrange: Mounts the component.
   Act: simulates user events.
   Assert: states what is expected.
